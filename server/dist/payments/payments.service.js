...
let PaymentsService = class PaymentsService {
    constructor(paymentRepository, workOrdersService) {
    ...
    async confirmPayment(id, transactionId) {
        ...
        await this.workOrdersService.update(payment.workOrderId, { status: work_order_entity_1.WorkOrderStatus.PAID }, null);
        return payment;
    }
    async refund(id) {
        const payment = await this.paymentRepository.findOne({ where: { id } });
